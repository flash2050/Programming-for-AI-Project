...
plt.title("Stock Price History of Apple Stock")
...
plt.figure(figsize=(16,8))
plt.title('Apple Stock Prediction using 24 epocs.')
plt.xlabel('Date')
plt.ylabel('Close Price USD ($)')
plt.plot(validation[['Close', 'Predictions']])
plt.legend(['Val', 'Predictions'], loc='lower right')
plt.savefig("..\..\Stock Prediction\AAPL\model_24_epocs.png")# chnge file name
plt.show()
