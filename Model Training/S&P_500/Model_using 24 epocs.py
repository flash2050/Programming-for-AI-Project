...
file = "..\..\Stock Dataset\S&P_500.csv"
...
plt.title("Stock Price History of S&P_500 Stock")
...
model.fit(x_train, y_train, batch_size = 1 ,epochs = 24, verbose = 1)
...
plt.figure(figsize=(16,8))
plt.title('S&P 500 Prediction using 24 epocs.')
plt.xlabel('Date')
plt.ylabel('Close Price USD ($)')
plt.plot(validation[['Close', 'Predictions']])
plt.legend(['Val', 'Predictions'], loc='lower right')
plt.savefig("..\..\Stock Prediction\S&P_500\model_24_epocs.png")# chnge file name
plt.show()
