...
model.fit(x_train, y_train, batch_size = 1 ,epochs = 12, verbose = 1)
...
plt.figure(figsize=(16,8))
plt.title('S&P 500 Prediction using 12 epocs.')
plt.xlabel('Date')
plt.ylabel('Close Price USD ($)')
plt.plot(validation[['Close', 'Predictions']])
plt.legend(['Val', 'Predictions'], loc='lower right')
plt.savefig("..\..\Stock Prediction\S&P_500\model_12_epocs.png")# chnge file name
plt.show()
